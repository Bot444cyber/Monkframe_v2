            ...
            <main className="flex-1 pt-32 pb-16 px-6">
                <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Let's start a conversation</h1>
                    ...
                    <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm">
                        {status === 'sent' ? (
                            <div className="h-full flex flex-col items-center justify-center text-center py-20">
                                ...
                                <button onClick={() => setStatus('idle')} className="mt-8 text-sm font-bold text-gray-900 hover:underline">Send another</button>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full py-3 text-sm bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-all shadow-sm active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
