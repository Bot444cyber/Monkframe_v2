...
export default function DashboardSkeleton() {
    return (
        <div className="min-h-screen bg-background text-foreground flex overflow-hidden">
            ...
            <aside className="hidden lg:flex fixed inset-y-0 left-0 z-50 w-72 bg-card border-r border-border shadow-2xl flex-col animate-pulse">
                ...
                <div className="p-6 space-y-4">
                    <div className="h-2 w-16 bg-muted mb-6 ml-4" />
                    {[...Array(5)].map((_, i) => (
            ...
            {/* Main Content Area */}
            <main className="flex-1 lg:ml-72 flex flex-col min-h-screen w-full relative animate-pulse">
                {/* Header Skeleton */}
                ...
                <div className="flex-1 p-6 lg:p-12 space-y-10">
                    ...
                    <div className="bg-card border border-border rounded-[2.5rem] h-[500px] p-8 mt-10">
                        <div className="h-6 w-48 bg-muted mb-8 rounded" />
