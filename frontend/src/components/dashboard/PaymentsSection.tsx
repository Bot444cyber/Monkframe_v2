                            ...
                            return (
                                <tr key={tx.id} className="hover:bg-white/[0.02] transition-colors group">
                                    ...
                                    <td className="px-8 py-6">
                                        {status !== 'COMPLETED' && (
                                            <button
                                                onClick={() => handleDelete(tx.id, orderId)}
                                                className="p-2 rounded-lg bg-rose-500/5 border border-rose-500/10 text-rose-500/60 hover:text-rose-400 hover:bg-rose-500/20 hover:border-rose-500/30 transition-all opacity-0 group-hover:opacity-100"
                                                title="Delete Record"
                                            >
