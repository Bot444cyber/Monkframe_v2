        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-md p-4">
            <div className="bg-card backdrop-blur-xl border border-border p-6 sm:p-8 rounded-3xl w-full max-w-lg relative animate-in fade-in zoom-in-95 shadow-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-xl sm:text-2xl font-bold text-foreground tracking-tight">{isAddOpen ? 'Deploy New Asset' : 'Update Asset'}</h3>
                    <button
                ...
                <div className="space-y-4">
                    <input
                        placeholder="Title"
                        className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-primary outline-none"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <input
                            ...
                            className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-emerald-500 outline-none"
                    ...
                    <input
                        ...
                        className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-pink-500 outline-none"
                        value={currentUI.color || ''}
                        onChange={e => setCurrentUI({ ...currentUI, color: e.target.value })}
                    />
                    <div className="space-y-1">
                        <label className="text-xs text-muted-foreground font-bold uppercase tracking-widest pl-1">Rating (0-5)</label>
                        <input
                            type="number"
                            min="0"
                            max="5"
                            step="0.1"
                            placeholder="4.8"
                            className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-yellow-500 outline-none"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <label
                                    ...
                                    className={`flex flex-col items-center justify-center w-full h-48 rounded-xl border-2 border-dashed transition-all cursor-pointer overflow-hidden ${previews.banner || currentUI.imageSrc ? 'border-primary/50 bg-primary/5' : 'border-border hover:border-border hover:bg-secondary'
                                        }`}
                                >
                                    {previews.banner || currentUI.imageSrc ? (
                                        <div className="relative w-full h-full p-2">
                                            ...
                                            <div className="absolute inset-0 flex items-center justify-center bg-background/50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg">
                                                <span className="text-xs font-bold text-foreground uppercase tracking-widest bg-background/80 px-4 py-2 rounded-full backdrop-blur-sm border border-border">Change Banner Image</span>
                                            </div>
                                        </div>
                                    ) : (
                    ...
                    {isAddOpen && (
                        <div className="space-y-4">
                            <label className="text-xs text-muted-foreground font-bold uppercase tracking-widest pl-1">UI Asset File</label>
                            <div className="relative">
                                ...
                                <label
                                    htmlFor="file-upload"
                                    className={`flex items-center gap-4 w-full p-4 rounded-xl border cursor-pointer transition-all ${files.uiFile ? 'bg-amber-500/10 border-amber-500/50' : 'bg-secondary border border-border hover:bg-secondary/80 hover:border-border'
                                        }`}
                                >
                                    <div className={`p-3 rounded-lg ${files.uiFile || currentUI.google_file_id ? 'bg-amber-500/20 text-amber-500' : 'bg-secondary text-muted-foreground'}`}>
                                        ...
                                        {files.uiFile ? (
                                            <>
                                                <div className="flex items-center gap-2">
                                                    <p className="text-sm font-bold text-foreground truncate max-w-[120px]">{files.uiFile.name}</p>
                                                    <span className="px-2 py-0.5 rounded bg-[#FF00FF] border border-border text-foreground text-[10px] font-black uppercase tracking-widest shadow-[0_0_10px_#FF00FF]">
                                            ...
                                            <>
                                                ...
                                                <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider">ID: {currentUI.google_file_id.slice(0, 8)}...</p>
                                            </>
                                        ) : (
                                            <>
                                    ...
                                    <div className="px-4 py-2 bg-secondary rounded-lg text-xs font-bold text-foreground uppercase tracking-wider group-hover:bg-secondary/80 transition-colors">
                    ...
                    {isAddOpen && (
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <label className="text-xs text-muted-foreground font-bold uppercase tracking-widest pl-1">Showcase Gallery (Max 3)</label>
                                ...
                                {[0, 1, 2].map((idx) => {
                                    ...
                                    return (
                                        <div key={idx} className="relative group aspect-square">
                                            {displayUrl ? (
                                                <div className="w-full h-full relative rounded-2xl overflow-hidden border border-border shadow-lg group-hover:border-primary/30 transition-all">
                                                ...
                                                <>
                                                    ...
                                                    <label
                                                        ...
                                                        className="flex flex-col items-center justify-center w-full h-full rounded-2xl border-2 border-dashed border-border bg-secondary/50 hover:border-primary/30 hover:bg-primary/5 transition-all cursor-pointer group/item ring-offset-background focus-within:ring-2 focus-within:ring-primary/50"
                                                    >
                                                        <div className="p-2 rounded-lg bg-secondary group-hover/item:bg-primary/20 transition-colors">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4 text-muted-foreground group-hover/item:text-primary">
                                                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                                                            </svg>
                                                        </div>
                                                        <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mt-2 group-hover/item:text-muted-foreground">Add</span>
                                                    </label>
                                                </>
                                            )}
                                        </div>
                    ...
                    <input
                        ...
                        className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-rose-500 outline-none"
                    ...
                    <textarea
                        ...
                        className="w-full bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-primary outline-none h-32 resize-none"
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            <label className="text-xs text-muted-foreground font-bold uppercase tracking-widest pl-1">Specifications</label>
                            <button
                                onClick={() => {
                                    const defaultSpecs = [
                                ...
                                className="text-[10px] bg-primary/10 hover:bg-primary/20 text-primary px-2 py-1 rounded-lg transition-colors uppercase font-bold tracking-wider"
                            >
                                Reset Defaults
                            </button>
                        </div>
                        <div className="space-y-3">
                            {(currentUI.specifications && Array.isArray(currentUI.specifications) ? currentUI.specifications : []).map((spec: any, idx: number) => (
                                <div key={idx} className="flex flex-col gap-2 p-3 rounded-xl bg-secondary/30 border border-border relative group">
                                    <div className="grid grid-cols-2 gap-2">
                                        <input
                                            placeholder="Label (e.g. Total Screens)"
                                            className="bg-secondary border border-border rounded-lg px-3 py-2 text-sm text-foreground focus:border-primary outline-none"
                                            value={spec.label}
                                            onChange={(e) => {
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-secondary border border-border rounded-lg px-3 py-2 text-xs text-muted-foreground focus:border-primary outline-none"
                                        value={spec.desc}
                                        onChange={(e) => {
                                            const newSpecs = [...(currentUI.specifications || [])];
                            ...
                            <button
                                ...
                                className="w-full py-2 border border-dashed border-border rounded-xl text-xs font-bold text-muted-foreground hover:text-foreground hover:bg-secondary transition-all uppercase tracking-wider"
                            >
                                + Add Specification
                            </button>
                        </div>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            <label className="text-xs text-muted-foreground font-bold uppercase tracking-widest pl-1">Highlights</label>
                            <button
                                onClick={() => {
                                    const newHighlights = [...(currentUI.highlights || []), ""];
                                    setCurrentUI({ ...currentUI, highlights: newHighlights });
                                }}
                                className="text-[10px] bg-secondary hover:bg-secondary/80 text-foreground px-2 py-1 rounded-lg transition-colors uppercase font-bold tracking-wider border border-border"
                            >
                                + Add Item
                            </button>
                        </div>
                            ...
                            {(currentUI.highlights && Array.isArray(currentUI.highlights) ? currentUI.highlights : []).map((highlight, idx) => (
                                <div key={idx} className="flex gap-2">
                                    <input
                                        ...
                                        className="flex-1 bg-secondary border border-border rounded-xl px-4 py-3 text-foreground focus:border-cyan-500 outline-none"
                                        value={highlight}
                                        onChange={(e) => {
                                            const newHighlights = [...(currentUI.highlights || [])];
                ...
                <div className="flex justify-end gap-3 mt-8">
                    <button onClick={() => { setIsAddOpen(false); setIsEditOpen(false); }} className="px-6 py-2 text-muted-foreground hover:text-foreground">Cancel</button>
                    <button onClick={handleSave} className="px-8 py-2 bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-xl shadow-lg shadow-primary/20">
