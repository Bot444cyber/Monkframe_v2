...
export function paymentSuccessTemplate(details: PaymentDetails): string {
    const content = `
    ...
    <div class="button-container">
      <a href="https://www.monkframer.online/billing" class="button">View Invoice in Dashboard</a>
    </div>
