...
router.get('/usage', auth_middleware_1.authenticateUser, (0, auth_middleware_1.authorizeRoles)('ADMIN'), googleDrive_controller_1.getStorageUsage);
...
router.post('/bulk-delete', auth_middleware_1.authenticateUser, (0, auth_middleware_1.authorizeRoles)('ADMIN'), googleDrive_controller_1.bulkDelete);
